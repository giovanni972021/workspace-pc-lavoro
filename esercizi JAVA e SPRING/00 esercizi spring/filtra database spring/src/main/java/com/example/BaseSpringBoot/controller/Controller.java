...
@RestController
@RequestMapping("/api") // Imposta il prefisso "api" per tutti gli endpoint della classe
@Tag(name = "Controller Principale", description = "Gestisce i messaggi di base") // Titolo nella legenda
public class Controller {
    ...
    @GetMapping("/saluto") // Path finale: localhost:8080/api/saluto
