...
public class Libro {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(libro.prezzo, prezzo) == 0 &&
                ...
                java.util.Objects.equals(titolo, libro.titolo) &&
                java.util.Objects.equals(autore, libro.autore);
    }

    @Override
    public int hashCode() {
        return java.util.Objects.hash(titolo, autore, prezzo, annoPubblicazione);
    }
}