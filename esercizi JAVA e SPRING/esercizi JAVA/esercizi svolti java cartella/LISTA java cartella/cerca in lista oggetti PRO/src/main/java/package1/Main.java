public class Main {
    public static void main(String[] args) {
        ...
        Libro libroDaCercare = new Libro("titolo2", "autore titolo2", 150.95, 1960);

        if (gestore.getLista_Libri().contains(libroDaCercare)) {
            System.out.println("Sì, il libro '" + libroDaCercare.getTitolo() + "' è presente in lista.\n");
        } else {
